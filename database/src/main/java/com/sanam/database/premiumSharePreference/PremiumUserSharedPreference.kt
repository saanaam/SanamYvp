package com.sanam.database.premiumSharePreference
...
class PremiumUserSharedPreference (context: Context) :
    ...
    override fun isShuffle(): Boolean {
        return sharedPreferences.getBoolean(SHUFFLE_KEY, false)
    }
    ...
    override fun isNextMusicEnable(): Boolean {
        return sharedPreferences.getBoolean(NEXT_KEY, true)

    }

    override fun isPreviousMusicEnable(): Boolean {
        return sharedPreferences.getBoolean(PREVIOUS_KEY, true)
    }
